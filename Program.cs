using Exeptions.Sorting;

namespace Exeptions.Sorting
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            var employees1 = new Teacher(new Person("Gleb", "Glinka"), 123, "Criminal law teacher",
                                         new Course("Criminal law", "Basics of criminal law,criminal code part one"));

            var employees2 = new Teacher(new Person("Asya", "Sledneva"), 321, "Criminal law teacher",
                                         new Course("Criminal law", "Basics of criminal law,criminal code part one"));

            var employees3 = new Teacher(new Person("Stefania", "Stanko"), 345, "English teacher",
                                         new Course("English readings", "Classic program from UK school"));

            var employees4 = new Teacher(new Person("Aleksandra", "Shatz"), 341, "English teacher",
                                         new Course("English readings", "Classic program from UK school"));

            var employees5 = new Teacher(new Person("Kirill", "Petrov"), 361, "Civil law teacher",
                                         new Course("Civil law", "Basics of civil law,civil code part one"));

            var employees6 = new SupportStaff(new Person("Alex", "Orech"), 432, "Security", "Checking students cards");

            var employees7 = new SupportStaff(new Person("Peter", "Sidorov"), 412, "Driver", "Books delivery to the libraries");

            var employees8 = new SupportStaff(new Person("Klara", "Tamara"), 567, "Cleaner", "Cleaning only first and four floors");
           ...
           try
           {
                new Teacher(new Person("Mark", "Vasilyev"), -103, "Criminal procces theacher",
                            new Course("Criminal procces", "Basics of criminal procces"));
           ...
           { 
            ...
            try
            {
                new Person ("Maaaaaaaark", "Vaaaaaaasiiiiilyyyyeeeev");
            }
            catch (ArgumentException ex)
            {
                Console.WriteLine(ex.Message);
            ...
            {
                Console.WriteLine(employee.LengthCheck());
            }
            ...
            employees.Sort(new OptionOneSort());
            employees.Reverse();
            ...
            var sortedLINQ = employees.OrderByDescending(x => x.LengthCheck()).ToList();

            foreach (var employee in sortedLINQ)
            {
